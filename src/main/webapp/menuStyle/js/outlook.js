...
function getSessionMenu(id){
	...
	$.ajax({
	    ...
	    dataType:"json",
	    async: false,
	    url : "../menu/getSessionMenuList.action",
	    success: function(d){
	    	if(d.data!=null&&d.data.basic.length>0){
	    		_menus = d.data;
	    	}else{
	    	}
	    },
...
function createFrame(url) {
	var s = '<iframe scrolling="auto" id="iframe_right" frameborder="0"  src="' + url + '" style="width:100%;height:100%;"></iframe>';
	return s;
}
